...
import { useRgbNonSpacedSyntax, getCssForMarkup, getStylesPerClassMap, minifyCss, escapeClassName } from '@vue-email/tailwind';
...
const ETailwind = defineComponent({
  ...
  async setup(props, { slots }) {
    ...
    let headStyles = [];
    const markupWithTailwindClasses = await renderToString(h("div", $default)).then((html2) => html2.replace(/^<div[^>]*>|<\/div>$/g, ""));
...
export { EBody, EButton, EColumn, EContainer, EFont, EHead, EHeading, EHr, EHtml, EImg, ELink, EMarkdown, EPreview, ERow, ESection, EStyle, ETailwind, EText, VueEmailPlugin, cleanup, deepmerge$1 as deepmerge, htmlToText, useRender };
